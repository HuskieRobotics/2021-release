...
public class Collector extends SubsystemBase {
  ...
  private final Solenoid collectorPistons = new Solenoid(RobotConstants.COMPRESSOR_CANID, CollectorConstants.collectorSolenoidChannel);
  ...
  public void deployIntake (boolean intakeOut) {
    if(intakeOut) {
      collectorPistons.set(false);
      collectorPistons.set(true);
    }
  }
