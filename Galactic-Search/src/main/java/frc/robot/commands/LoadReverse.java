...
public class LoadReverse extends CommandBase {
  
  private final Storage storage;
  private double initialStoragePosition = 0;
  private boolean intake;
  public LoadReverse(Storage s) {
    storage = s;
  ...
  public void execute() {
    ...
    double distanceTraveled = Math.abs(storage.getEncoderPosition()-initialStoragePosition);
